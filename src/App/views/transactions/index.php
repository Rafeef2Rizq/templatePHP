                ...
                <tbody class="divide-y divide-slate-50">
                    <?php foreach ($transactions as $transaction): ?>
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            <td class="px-6 py-5">
                                <span
                                    class="font-bold text-slate-700 tracking-tight"><?php echo e($transaction['description']); ?></span>
                            </td>
                            <td class="px-6 py-5">
                                <span class="font-black text-red-600 tracking-tight">
                                    ...
                                    <?php foreach ($transaction['receipts'] as $receipt): ?>
                                        <div class="relative group/receipt">
                                            ...
                                            <form
                                                ...
                                                <button type="submit"
                                                    class="w-5 h-5 bg-red-500 text-white rounded-full flex items-center justify-center ring-2 ring-white">
                            ...
                            <td class="px-6 py-5">
                                <div class="flex flex-col">
                                    <span
                                        class="text-sm font-bold text-slate-600"><?php echo e($transaction['formatted_date']); ?></span>
