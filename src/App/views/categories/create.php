...
<main class="container mx-auto mt-12 mb-10 px-6 max-w-3xl">
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="text-left">
            <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Create Category</h1>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input value="<?php echo e($oldForm['name'] ?? ''); ?>" name="name" type="text"
                                placeholder="e.g. Health, Shopping, Salary"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group flex items-center gap-3">
                                <input value="<?php echo e($oldForm['color'] ?? '#6366f1'); ?>" name="color"
                                    type="color"
